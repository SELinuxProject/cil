...
void test_cil_resolve_nodecon(CuTest *tc) {
	char *line[] = {"(", "user", "user_u", ")",
			...
			"(", "level", "high", "(", "s0", "(", "c0", ")", ")", ")",
			"(", "context", "con", "(", "user_u", "role_r", "type_t", "low", "high", ")", ")",
			"(", "nodecon", "ipaddr", "ipaddr", "con", ")", NULL};
...
void test_cil_resolve_nodecon_neg(CuTest *tc) {
	char *line[] = {"(", "user", "user_u", ")",
			...
			"(", "level", "high", "(", "s0", "(", "c0", ")", ")", ")",
			"(", "context", "con", "(", "user_u", "role_r", "type_t", "low", "high", ")", ")",
			"(", "nodecon", "ipaddr", "ipaddr", "conn", ")", NULL};
...
void test_cil_resolve_nodecon_anon_context(CuTest *tc) {
	char *line[] = {"(", "user", "user_u", ")",
			...
			"(", "level", "low", "(", "s0", "(", "c0", ")", ")", ")",
			"(", "level", "high", "(", "s0", "(", "c0", ")", ")", ")",
			"(", "nodecon", "ipaddr", "ipaddr", "(", "user_u", "role_r", "type_t", "low", "high", ")", ")", NULL};
...
void test_cil_resolve_nodecon_anon_context_neg(CuTest *tc) {
	...
	int rc = cil_resolve_nodecon(test_db, test_db->ast->root->cl_head->next->next->next->next->next->next, NULL);
	CuAssertIntEquals(tc, SEPOL_ENOTSUP, rc);
}
...
void test_cil_evaluate_expr_stack_and(CuTest *tc) {
	...
	cil_resolve_expr_stack(test_db, tif->expr_stack, test_db->ast->root->cl_head->next->next->next, NULL, CIL_TUNABLE);
...
void test_cil_resolve_ast_node_helper_nodecon_neg(CuTest *tc) {
	char *line[] = {"(", "user", "user_u", ")",
			...
			"(", "level", "high", "(", "s0", "(", "c0", ")", ")", ")",
			"(", "context", "con", "(", "user_u", "role_r", "type_t", "low", "high", ")", ")",
			"(", "nodecon", "ipaddr", "ipaddr", "foo", ")", NULL};
