...
int cil_tree_walk(uint32_t, struct cil_tree_node *, int (*process)(struct cil_tree_node *, uint32_t *, struct cil_list *), int (*finished_branch)(struct cil_tree_node *, uint32_t *, struct cil_list *), struct cil_list *);
